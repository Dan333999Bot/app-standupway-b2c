...
const REGISTRY: Record<string, PlanConfig> = {
  ...
  "famiglie-colloquio": {
    ...
    configMonthly: "stripe_v2_famiglie_colloquio_url",
    color:    "border-primary/40",
    badgeBg:  "bg-primary/10 text-primary",
    headerBg: "bg-primary/8",
  ...
  "famiglie-gruppi": {
    ...
    configMonthly: "stripe_v2_famiglie_gruppi_mensile_url",
    configAnnual:  "stripe_v2_famiglie_gruppi_annuale_url",
    color:    "border-emerald-500/40",
    badgeBg:  "bg-emerald-500/10 text-emerald-600",
    headerBg: "bg-emerald-500/8",
  ...
  "famiglie-completo": {
    ...
    configMonthly: "stripe_v2_famiglie_completo_mensile_url",
    configAnnual:  "stripe_v2_famiglie_completo_annuale_url",
    color:    "border-amber-500/40",
    badgeBg:  "bg-amber-500/10 text-amber-600",
    headerBg: "bg-amber-500/8",
